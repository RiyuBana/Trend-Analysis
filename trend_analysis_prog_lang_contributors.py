...
data_1 = pandas.read_csv("data/lang2.csv", header=0)
...
for i in range(0,len(fin_list)):
    with open('data/trend_2015_contrib.csv', 'r') as f1:
...
#for n in fin_list:
for i in range(0,len(fin_list)):
    with open('data/trend_2016_contrib.csv', 'r') as f2:
...
#for n in fin_list:
for i in range(0,len(fin_list)):
    with open('data/trend_2017_contrib.csv', 'r') as f3:
...
plt.title('Number of Contributors per Year for particular language (Popularity of Programming Languages per year)')
